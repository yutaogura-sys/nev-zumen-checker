...
(function (root) {
  ...
  const rule = {
    ...
    checks: [
      ...
      // ── EV充電設備 ──
      { id: 'equipment_labels', category: 'ev_equipment', label: 'EV充電設備の通し番号ラベル',
      ...
      // ── 路面・寸法 ──
      { id: 'surface_material', category: 'surface_dimensions', label: '路面状況（材質）の記載',
      ...
      { id: 'ground_marking_surface', category: 'mokutekichi_specific', label: '路面表示の設置面（材質確認）',
