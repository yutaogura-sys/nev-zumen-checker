  ...
  const rule = {
    ...
    checks: [
      ...
      { id: 'building_name', category: 'kiso_specific', label: '建物名称の明記',
        description: 'マンション・団地などの建物名称が図面上で確認できるか（表示の大きさは問わない。表題欄・図中いずれでも可）', required: true },
      ...
      { id: 'charging_count_kiso', category: 'kiso_specific', label: '充電スペース数の記載（任意）', src: '社内基準',
        description: '充電スペースの台数（例: 充電スペース×8）が記載されているか。※手引き5-9-1の要求は「場所の記載」のみのため任意（2026-07-14格下げ・ユーザー承認）。台数の読み取り自体は検算・図面間照合に使用する。', required: false },
      ...
      { id: 'facility_name', category: 'mokutekichi_specific', label: '施設名称の明記',
        description: '店舗・ホテル・施設の名称が図面上で確認できるか（表示の大きさは問わない。表題欄・図中いずれでも可）', required: true },
      { id: 'charging_count_moku', category: 'mokutekichi_specific', label: '充電スペース数の記載（任意）', src: '社内基準',
        description: '充電スペースの台数（例: 充電スペース×4）が記載されているか。※手引き5-9-1の要求は「場所の記載」のみのため任意（2026-07-14格下げ・ユーザー承認）。台数の読み取り自体は検算・図面間照合に使用する。', required: false },
